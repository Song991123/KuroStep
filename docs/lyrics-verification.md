...
KuroStep은 YouTube 영상에서 가사를 직접 추출하지 않습니다. YouTube 링크에서 곡 제목과 아티스트를 정리한 뒤, LRCLIB에서 해당 곡의 가사를 검색합니다.
...
| LRCLIB 미등록 곡 | 사용자가 이해할 수 있는 안내 메시지 표시 |
| YouTube 광고/계정 제한 | 광고를 우회하지 않고, 공식 플레이어 상태를 그대로 안내 |
